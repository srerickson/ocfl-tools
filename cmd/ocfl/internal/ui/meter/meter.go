...
func (m Meter) BytesCounter() string {
	return fmt.Sprintf("%d %ss", int64(m.Total), "bytes")
...
func RunProgram(ctx context.Context, m tea.Model, run func(context.Context, chan<- IOMsg) error) error {
	...
	go func() {
		// this go routine accumulates read event messages
...
func (mfs *OnReadFS) Open(name string) (fs.File, error) {
...
func (mfs *OnReadFS) ReadDir(name string) ([]fs.DirEntry, error) {
